...
final List<String> _subtitlesList = [
  'Dành cả cuộc sống của bạn để vuốt phải tìm kiếm bạn đời',
  'Trò chuyện riêng với những người bạn phù hợp.',
  'Hãy vui vẻ với những cuộc trò chuyện của bạn bằng cách gửi ảnh và video cho nhau.',
  'Nhận thông báo khi bạn nhận được tin nhắn và kết quả tương hợp mới.'
];
